...
namespace ListT
{
    ...
    public class List<T> : IEnumerable, IEnumerator
    {
        ...
        public void InsertElementByPosition(T value, int position)
        {
        ...
        private ListElement CurrentEl(int position)
        {
            var temp = head;
            for (int i = 0; i < position; i++)
            {
        ...
        {
            numerator++;
            return !(CurrentEl(numerator) == null);
        }
